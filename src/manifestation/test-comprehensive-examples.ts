/**
 * Comprehensive Test Examples for All Categories
 * Tests: Career, Love, Personal, Money, Business, Farming, Family, Health, Spiritual
 */
...
interface TestCase {
  ...
  language?: 'english' | 'hindi' | 'mixed' | 'typo';
}
...
/**
 * Simple category detection function (matching the service logic)
 */
