...
@Entity('manifest_to_manifest_templates')
@Index(['category_id'])
@Index(['subcategory_id'])
@Index(['is_active'])
@Index(['priority'])
export class ManifestToManifestTemplate {
  ...
  // Relations
  @ManyToOne(() => ManifestCategory, (category) => category.to_manifest_templates, { onDelete: 'CASCADE' })
  @JoinColumn({ name: 'category_id' })
  category: ManifestCategory | null;

  @ManyToOne(() => ManifestSubcategory, (subcategory) => subcategory.to_manifest_templates, { onDelete: 'SET NULL' })
