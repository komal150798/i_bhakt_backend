...
@Entity('manifest_alignment_templates')
@Index(['category_id'])
@Index(['subcategory_id'])
@Index(['is_active'])
@Index(['priority'])
export class ManifestAlignmentTemplate {
  ...
  // Relations
  @ManyToOne(() => ManifestCategory, (category) => category.alignment_templates, { onDelete: 'CASCADE' })
  @JoinColumn({ name: 'category_id' })
  category: ManifestCategory | null;

  @ManyToOne(() => ManifestSubcategory, (subcategory) => subcategory.alignment_templates, { onDelete: 'SET NULL' })
