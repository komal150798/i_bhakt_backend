...
@Entity('manifest_not_to_manifest_templates')
@Index(['category_id'])
@Index(['subcategory_id'])
@Index(['is_active'])
@Index(['priority'])
export class ManifestNotToManifestTemplate {
  ...
  // Relations
  @ManyToOne(() => ManifestCategory, (category) => category.not_to_manifest_templates, { onDelete: 'CASCADE' })
  @JoinColumn({ name: 'category_id' })
  category: ManifestCategory | null;

  @ManyToOne(() => ManifestSubcategory, (subcategory) => subcategory.not_to_manifest_templates, { onDelete: 'SET NULL' })
