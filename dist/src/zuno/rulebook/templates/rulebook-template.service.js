...
exports.RulebookTemplateService = void 0;
const common_1 = require("@nestjs/common");
const ExcelJS = require("exceljs");
const workbook_schema_1 = require("../parsing/workbook-schema");
const enums_1 = require("../../common/enums");
let RulebookTemplateService = class RulebookTemplateService {
    async generate() {
    ...
    addSheet(workbook, spec) {
        ...
        spec.columns.forEach((column, index) => {
            ...
            sheet.getColumn(index + 1).width = Math.min(Math.max(column.header.length + 6, 18), 45);
        });
        headerRow.height = 32;
        headerRow.commit();
    ...
    addDropdowns(sheet, spec) {
        const vocabularies = {
            domain: [...enums_1.ZUNO_DOMAINS],
            theme: Object.values(enums_1.RuleTheme),
            direction: Object.values(enums_1.ThemeDirection),
            strength: Object.values(enums_1.ThemeStrength),
            safety_class: Object.values(enums_1.RuleSafetyClass),
            status: Object.values(enums_1.RuleStatus),
            sme_confidence: Object.values(enums_1.SmeConfidence),
            window_type: Object.values(enums_1.TimingWindowType),
            remedy_type: Object.values(enums_1.RemedyType),
            mka_dimension: Object.values(enums_1.MkaDimension),
            frequency: Object.values(enums_1.RemedyFrequency),
            sensitive_subjects: Object.values(enums_1.SensitiveSubject),
    ...
    exampleRow(sheet) {
        switch (sheet) {
            case enums_1.RulebookSheet.CONFIGURATION:
                return {
                    setting: 'AYANAMSA',
                    value: 'LAHIRI',
                    notes: 'EXAMPLE - replace with your chosen methodology',
                };
            case enums_1.RulebookSheet.DOMAINS:
                return {
                    domain: 'CAREER',
                    primary_houses: '10, 6',
                    ...
                    methodology_notes: 'EXAMPLE ROW - delete this and enter your own methodology. Do not treat these houses as approved doctrine.',
                };
            case enums_1.RulebookSheet.RULES:
                return {
                    ...
                    supporting_factors: 'Transit of a slow-moving planet over the 10th | Dasha lord weak by placement',
            ...
            case enums_1.RulebookSheet.INTERPRETATIONS:
                return {
                    interpretation_id: 'INT-CAREER-001',
                    theme: 'VOLATILITY',
                    meaning: 'EXAMPLE - This period may involve increased uncertainty, restructuring or unexpected professional change. Note how this describes a condition without asserting an outcome.',
                    allowed_domains: 'CAREER',
                    user_safe_summary: 'Work may feel less predictable for a while.',
                    status: 'DRAFT',
                };
            case enums_1.RulebookSheet.TIMING_RULES:
                return {
                    ...
                    timing_language: 'The coming months are better used for preparation than for major commitments.',
                    status: 'DRAFT',
                };
            case enums_1.RulebookSheet.REMEDIES:
                return {
                    ...
                    instructions: 'Ten minutes of quiet breathing after waking, before checking any messages.',
                    frequency: 'DAILY',
                    duration: '40 days',
            ...
            case enums_1.RulebookSheet.CONFLICT_RULES:
                return {
                    conflict_id: 'CONF-001',
                    rule_ids: 'ASTRO-CAREER-001, ASTRO-CAREER-002',
                    resolution_strategy: 'PRESERVE_BOTH',
                    winning_rule_id: '',
                    rationale: 'EXAMPLE - pressure and support can coexist; ZUNO should report both rather than cancelling them out.',
                };
            case enums_1.RulebookSheet.GOLDEN_CASES:
                return {
                    ...
                    challenge_statement: 'Many people have been laid off in my company. I have a home loan and I am worried about what happens if I lose my job.',
                    expected_rule_ids: 'ASTRO-CAREER-001',
                    expected_themes: 'VOLATILITY',
                    expected_outcome_notes: 'EXAMPLE - use synthetic birth data only, never a real person. Expect caution plus preparation, never a prediction of job loss.',
                };
            default:
                return null;
        }
...
exports.RulebookTemplateService = RulebookTemplateService;
exports.RulebookTemplateService = RulebookTemplateService = __decorate([
...
//# sourceMappingURL=rulebook-template.service.js.map