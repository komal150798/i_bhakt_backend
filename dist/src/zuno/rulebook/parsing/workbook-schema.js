...
exports.RULEBOOK_WORKBOOK_SCHEMA = void 0;
exports.sheetSpec = sheetSpec;
exports.normaliseHeader = normaliseHeader;
const enums_1 = require("../../common/enums");
exports.RULEBOOK_WORKBOOK_SCHEMA = [
    {
        sheet: enums_1.RulebookSheet.CONFIGURATION,
        required: false,
        description: 'Rulebook-level settings: ayanamsa, house system, calculation methodology. Step 08 sections 4-6.',
        columns: [
    ...
    },
    {
        ...
        required: true,
        description: 'Per-domain astrological methodology. Step 08 sections 12-13. A domain is NOT simply a house - fill these from your own methodology, not from generic assumptions.',
        columns: [
    ...
    },
    {
        ...
        required: true,
        description: 'The astrology rules themselves. Step 08 section 8 (rule anatomy). One row per rule.',
        columns: [
    ...
    },
    {
        ...
        required: true,
        description: 'What each theme MEANS. Step 08 sections 24-28. This meaning is preserved exactly - ZUNO may reword for tone, never change the meaning, direction or severity.',
        columns: [
    ...
    },
    {
        ...
        required: false,
        description: 'Timing windows. Step 08 sections 29-33. A window is NOT an event prediction.',
        columns: [
    ...
    },
    {
        ...
        required: false,
        description: 'Approved remedies. Step 08 sections 39-59. ZUNO will never invent one - if it is not here, it is never suggested.',
        columns: [
    ...
    },
    {
        ...
        required: false,
        description: 'How to resolve rules that disagree. Step 10 section 16. ZUNO will never invent a precedence hierarchy - if two rules conflict and no row here covers it, it falls back safely and flags it for you.',
        columns: [
    ...
    },
    {
        ...
        required: false,
        description: 'Regression test cases. Step 08 sections 70-72. Use SYNTHETIC birth data only - never a real person.',
        columns: [
...
function sheetSpec(sheet) {
    return exports.RULEBOOK_WORKBOOK_SCHEMA.find((s) => s.sheet === sheet);
}
...
//# sourceMappingURL=workbook-schema.js.map