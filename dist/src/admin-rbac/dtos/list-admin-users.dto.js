...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, default: 20, minimum: 1, maximum: 100 }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(1),
...
__decorate([
    ...
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
], ListAdminUsersDto.prototype, "role_id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false }),
    (0, class_validator_1.IsOptional)(),
...
], ListAdminUsersDto.prototype, "is_enabled", void 0);
