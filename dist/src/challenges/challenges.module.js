...
const app_challenges_controller_1 = require("./controllers/app-challenges.controller");
...
exports.ChallengesModule = ChallengesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([challenge_entity_1.Challenge, user_challenge_entity_1.UserChallenge]),
            users_module_1.UsersModule,
        ],
        controllers: [app_challenges_controller_1.AppChallengesController],
